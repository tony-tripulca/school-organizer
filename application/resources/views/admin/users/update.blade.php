                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-5">
                            ...
                            <input type="text" class="update-input form-control" name="last_name">
                        </div>
                        <div class="form-group col-7">
                            <small class="text-muted">First name</small>
                            <input type="text" class="update-input form-control" name="first_name">
                        </div>
                        <div class="form-group col-5">
                            <small class="text-muted">Middle name</small>
                            <input type="text" class="update-input form-control" name="middle_name">
                        </div>
                        <div class="form-group col-3">
                            <small class="text-muted">Suffix</small>
                            <input type="text" class="update-input form-control" name="suffix">
                        </div>
                        <div class="form-group col-4">
                            <small class="text-muted">Gender</small>
                            <select class="update-input custom-select" name="gender">
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="update-input form-control" name="full_address">
                            </div>
                        </div>
                        <div class="form-group col-12 col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="update-input form-control" name="mobile">
                            </div>
                        </div>
                    </div>
                    <div class="form-row for-student">
                        <div class="form-group col-12 col-md-6">
                            <small class="text-muted">Father's name</small>
                            <input type="text" class="update-input form-control" name="father_name">
                        </div>
                        <div class="form-group col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="update-input form-control" name="father_mobile">
                            </div>
                        </div>
                        <div class="form-group col-12 col-md-6">
                            <small class="text-muted">Mother's name</small>
                            <input type="text" class="update-input form-control" name="mother_name">
                        </div>
                        <div class="form-group col-12 col-md-6">
                            <small class="text-muted">Mobile number</small>
                            <div class="input-group">
                                ...
                                <input type="text" class="update-input form-control" name="mother_mobile">
                            </div>
                        </div>
                    </div>
                </div>
